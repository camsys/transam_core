                ...
                <tr>\
                    <td width="50%">\
                        <div class="selector-available">\
                            ...
                            <select multiple="multiple" class="filtered remaining form-control">\
                            </select>\
                            <a href="#" class="selector-chooseall"><i class="fa fa-chevron-circle-right"></i> Choose all</a>\
                        </div>\
                    </td>\
                    <td>\
                        <div class="selector-chooser">\
                            <a href="#" class="selector selector-add"><i class="fa fa-chevron-circle-right"></i> add</a>\
                            <a href="#" class="selector selector-remove"><i class="fa fa-chevron-circle-left"></i> rem</a>\
                        </div>\
                    </td>\
                    <td width="50%">\
                        <div class="selector-chosen">\
                            ...
                            <select multiple="multiple" class="filtered target form-control">\
                            </select>\
                            <a href="#" class="selector-clearall"><i class="fa fa-chevron-circle-left"></i> Clear all</a>\
                        </div>\
                    </td>\
                </tr>\
            </table>',

...
(function ($) {
    ...
    var idsStateSaveList = {
        ...
        columns: 'bs.table.visible_columns',
    ...
    BootstrapTable.prototype.initStateSave = function () {
        ...
        if (columnsStateSave) {
            ...
            if (!$.isArray(this.options.columns[0])) {
                table_columns = this.options.columns;
            } else {
                table_columns = this.options.columns[0];
            }
            $.each(table_columns, function (i, column) {

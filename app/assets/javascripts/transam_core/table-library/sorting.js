$(document).ready(function(){
    $(document).on("mousedown",".library-table table[data-sort='client'] .header-item:not(.header-checkbox):has(.header-icons)",(function(){
    ...
    $(document).on("mousedown",".library-table table[data-sort='server'] .header-item:not(.header-checkbox):has(.header-icons)",(async function(){
...
const getCellValue = (row, index) => { 
    ...
    if($(td).hasClass("checkmark-column") || $(td).hasClass("x-column")) { return $(td).children().eq(0).children().eq(0).css("visibility")=="hidden"; } // needs a lot of work but gets the job done

$(document).ready(function(){
    $(document).on("click",".library-table table[data-sort='client'] .header-item",(function(){
        ...
        // updateSortPreferences(table.data('tableCode');, sort_params);
...
function updateSortPreferences(table_code, sort_params) {
  $.ajax({
    type: "POST",
    contentType: "application/json; charset=utf-8",
    data:{"table_code":table_code, "sort_params":sort_params},

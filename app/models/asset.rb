...
class Asset < ActiveRecord::Base
  ...
  scope :search_query, lambda {|organization, search_text| {:conditions => [Asset.get_search_query_string(Sign.new.searchable_fields), {:organization_id => organization.id, :search => search_text }]}}  

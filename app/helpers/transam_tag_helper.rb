...
")
  ...
  #
  def editable_asset_field_tag(asset, field, label=nil, required: true, type: 'text', min: nil, max: nil, suffix: '', inputclass: '', maxyear: Date.today.year, current_value: nil)
    if type == 'boolean'

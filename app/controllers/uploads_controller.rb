class UploadsController < OrganizationAwareController
  ...
  add_breadcrumb SystemConfigFieldCustomization.find_by(table_name: 'uploads', field_name: nil)&.label || "Bulk Updates", :uploads_path
  ...
  def new
    ...
    add_breadcrumb SystemConfigFieldCustomization.find_by(table_name: 'uploads', field_name: 'new')&.label || "New Template"

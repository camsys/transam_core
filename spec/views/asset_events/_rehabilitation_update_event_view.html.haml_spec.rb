...
describe "asset_events/_rehabilitation_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_subsystem = create(:asset_subsystem, :asset_type => test_asset.asset_subtype.asset_type)
    test_asset.asset_events.create!(attributes_for(:rehabilitation_update_event, :transam_asset => test_asset, :extended_useful_life_months => 12, :extended_useful_life_miles => 1000, :comments => 'test comment 123'))

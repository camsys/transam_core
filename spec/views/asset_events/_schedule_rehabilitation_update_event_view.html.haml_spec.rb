...
describe "asset_events/_schedule_rehabilitation_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:schedule_rehabilitation_update_event, :transam_asset => test_asset, :rebuild_year => 2010, :comments => 'test comment 123'))

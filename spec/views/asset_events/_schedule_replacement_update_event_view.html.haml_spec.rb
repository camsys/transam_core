...
describe "asset_events/_schedule_replacement_update_event_view.html.haml", :type => :view do
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:schedule_replacement_update_event, :transam_asset => test_asset, :replacement_year => 2010, :replacement_reason_type_id => 1, :comments => 'test comment 123'))

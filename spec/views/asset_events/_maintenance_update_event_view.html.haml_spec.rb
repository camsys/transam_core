...
describe "asset_events/_maintenance_update_event_view.html.haml", :type => :view do
  ...
  it 'info' do
    ...
    test_asset.asset_events.create!(attributes_for(:maintenance_update_event, :maintenance_type_id => 1, :current_mileage => 44444, :comments => 'test comment 123'))
    ...
    expect(rendered).to have_content(MaintenanceType.first.to_s)

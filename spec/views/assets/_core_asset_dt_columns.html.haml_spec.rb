...
describe "assets/_core_asset_dt_columns.html.haml", :type => :view do
  it 'info' do
    test_asset = create(:buslike_asset, :description => 'test description 123', :parent => create(:buslike_asset), :in_service_date => Date.new(2010, 7, 1), :reported_condition_rating => 4, :service_status_type_id => 1, :scheduled_rehabilitation_year => 2024, :scheduled_replacement_year => 2025)

...
ActiveRecord::Schema.define(version: 20140917152701) do
  ...
  add_index "attachments", ["asset_id"], name: "attachments_idx2", using: :btree
  add_index "attachments", ["attachment_type_id"], name: "attachments_idx3", using: :btree
  add_index "attachments", ["object_key"], name: "attachments_idx1", using: :btree
  ...
  add_index "tasks", ["for_organization_id"], name: "tasks_idx4", using: :btree
  add_index "tasks", ["from_organization_id"], name: "tasks_idx3", using: :btree
  add_index "tasks", ["from_user_id"], name: "tasks_idx2", using: :btree

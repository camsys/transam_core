...
RSpec.describe ConditionUpdateEvent, :type => :model do
  ...
  it '#allowable_params' do
    expect(ConditionUpdateEvent.allowable_params).to eq([:condition_type_id, :assessed_rating, :created_by_id, {:condition_type_percents_attributes => [ConditionTypePercent.allowable_params]}])
  end

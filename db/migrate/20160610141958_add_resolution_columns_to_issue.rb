class AddResolutionColumnsToIssue < ActiveRecord::Migration
  def change
    ...
    unless column_exists? :issues, :issue_status
      add_column    :issues, :issue_status, :string, :after => :comments, :default => 'Open'
    end

class AddSystemConfigFieldCustomizations < ActiveRecord::DataMigration
  def up
    ...
    SystemConfigFieldCustomization.create!(table_name: 'policy_asset_type_rules', field_name: 'service_life_calculation_type_id', is_locked: true, active: true, code_frag: '@policy.parent.present?')
  end
end